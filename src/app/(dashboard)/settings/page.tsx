...
function SettingsPageInner() {
  ...
  const { defaultCurrency, canManageMembers, profileLoading } = useAuth();
  const { mode } = useTheme();
  ...
  const section = (!profileLoading && SECTION_META[rawSection]?.adminOnly && !canManageMembers) ? 'overview' : rawSection;
